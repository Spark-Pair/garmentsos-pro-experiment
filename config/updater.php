...
return [
    ...
    'actions_server_pc_only' => env('UPDATE_ACTIONS_SERVER_PC_ONLY', true),
    'server_pc_hosts' => array_values(array_filter(array_map('trim', explode(',', env('UPDATE_SERVER_PC_HOSTS', 'localhost,127.0.0.1,::1'))))),
    'server_pc_ips' => array_values(array_filter(array_map('trim', explode(',', env('UPDATE_SERVER_PC_IPS', '127.0.0.1,::1'))))),
    ...
    'current_version' => env('APP_VERSION', '1.8.75'),
