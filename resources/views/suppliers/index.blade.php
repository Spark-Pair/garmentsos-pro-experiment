@extends('app')
@section('title', 'Show Suppliers | ' . $client_company->name)
@section('content')
    @php
        $searchFields = [
            "Supplier Name" => [
