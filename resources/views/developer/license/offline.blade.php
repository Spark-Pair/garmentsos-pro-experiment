...
@section('content')
    ...
    <div class="w-full max-w-5xl mx-auto p-4 md:p-6 space-y-6 text-[var(--text-color)]">
        <header class="{{ $panel }} p-5">
            <x-developer-panel-title title="Offline Activation" description="Export a safe installation request code, import a signed license response, or generate a manual reactivation request." class="mb-0 border-b-0 pb-0" />
        </header>

        <div class="grid gap-4 lg:grid-cols-2">
            <section class="{{ $panel }} p-5 space-y-4">
                <div>
                    <h2 class="text-sm font-semibold uppercase tracking-wide">Request Code</h2>
            ...
            <section class="{{ $panel }} p-5 space-y-4">
                <div>
                    <h2 class="text-sm font-semibold uppercase tracking-wide">Import Signed License</h2>
                    <p class="mt-1 text-sm text-[var(--secondary-text)]">
        ...
        <section class="{{ $panel }} p-5 space-y-4">
            <div>
                <h2 class="text-sm font-semibold uppercase tracking-wide">Reactivation Request</h2>
                <p class="mt-1 text-sm text-[var(--secondary-text)]">
